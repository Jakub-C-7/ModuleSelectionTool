...
/**
 * The ModuleSelectionMenuBar is the menu at the top of the application.
 * 
 * The File part of the menu is made up of menu items: Load Student Data, Save Student Data and Exit.
 * The About part of the menu is made up of one item: About.
 * 
